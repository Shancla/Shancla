...
<body onLoad="initialize()" onUnload="GUnload()">
	<header>
        <nav class="user">
            <ul>
                ...
                <li><a href="#" class="nuevoanuncio">Publica tu anuncio</a></li>
            </ul>
        </nav><!-- user -->
    </header>
    <div class="inline" id="miubicacion">
		...
		<hr/> 
		<!-- comienza modificacion direccion plano -->
		<script type="text/javascript" src="js/codificacion_direccion.js"></script>
		<form class="ubicacion" onSubmit="return searchLocations()">
		  <input type="text" id="addressInput" />
		  <input type="submit" value="Buscar" class="boton" />
		  <!--<input type="button" onclick="searchLocations()" value="Buscar" class="boton"/>-->
		</form>
		 <!-- fin modificacion direccion plano -->
